...
SELECT ADD_MONTHS(TO_DATE('2022-12-16', 'YYYY-MM-DD'), 3) FROM dual;
SELECT NEXT_DAY(TO_DATE('2023-08-05', 'YYYY-MM-DD'), 2) FROM dual;
SELECT LAST_DAY(TO_DATE('2023-08-05', 'YYYY-MM-DD')) FROM dual;
SELECT ROUND(TO_DATE('2023-08-15', 'YYYY-MM-DD'), 'MONTH') FROM dual;
...
SELECT last_name, salary, NVL(commission_pct, 0), (salary *12) AS AN_SAL,
